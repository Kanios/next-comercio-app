        ...
        <section>
            <div className="w-full bg-blue rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <p className="text-white">Inicia sesión con Usuario</p>
                    <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="flex justify-between">
                            <Link href="/comercio/loginComercio" className="align-start text-xs font-thin text-white hover:underline">Iniciar sesión con Comercio</Link>
                        </div>
