    ...
    return (
        <section className="">
            <div className="w-full bg-black rounded-lg shadow dark:border md:mt-0  xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                ...
                <p className="text-white">Cambiar Datos</p>
                    <form className="space-y-4 md:space-y-6">
                        ...
                        <button onClick={handleEliminarCuentaClick} className="w-full text-red-600 bg-white hover:bg-red-200 focus:ring-4 focus:outline-none font-medium rounded-full text-sm px-5 py-2.5 text-center">Eliminar Cuenta</button>
